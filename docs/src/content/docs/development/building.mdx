...
- macOS 14 or later
- Xcode 27 or later (Swift 6.4)
- Node.js 24 and Bun only when working on this documentation site
...
Run `bun run check` and `bun run build` before submitting documentation changes. Astro emits the
