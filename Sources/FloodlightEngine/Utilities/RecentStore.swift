...
package final class RecentStore: Sendable {
    ...
    private static let launchSaturation = 25
    ...
    private static let maximumLaunchComponent = FuzzyMatcher.maximumLearningBoost * 5 / 9
    private static let maximumRecencyComponent =
